...
ZLIBCPPFLAGS=-I/opt/codesourcery/zlib/include
ZLIBLDFLAGS=-L/opt/codesourcery/zlib/lib
LZOCPPFLAGS=-I/opt/codesourcery/lzo/include
LZOLDFLAGS=-L/opt/codesourcery/lzo/lib
UUIDCPPFLAGS=-I/opt/codesourcery/include
UUIDLDFLAGS=-L/opt/codesourcery/lib
CC := $(CROSS)gcc
AR := $(CROSS)ar
RANLIB := $(CROSS)ranlib
